...
var cardsDb = []card{
	...
	&unitCard{
		...
		baseAtk:          1,
		baseHP:           1,
		passiveAbilities: []unitPassiveAbility{{code: UPA_HASTE}},
		startingDeck:     true,
	},
	&unitCard{
		cost:         1,
	...
	&unitCard{
		...
		baseAtk:          1,
		baseHP:           2,
		passiveAbilities: []unitPassiveAbility{{code: UPA_HEALING, value: 1}},
		startingDeck:     true,
	},
	&unitCard{
		cost:         3,
	...
	&unitCard{
		...
		baseAtk:          2,
		baseHP:           2,
		passiveAbilities: []unitPassiveAbility{{code: UPA_FRENZY, value: 1}},
		startingDeck:     true,
	},
	&magicCard{
		cost:         1,
		...
		triggersSpell: &spell{
			...
			canTargetEnemy:   true,
			targetableZones:  []int{PLAYERZONE_PATROL},
	...
	&magicCard{
		...
		triggersSpell: &spell{
			...
			canTargetHeroes:  true,
			canTargetOwner:   true,
			targetableZones:  []int{PLAYERZONE_PATROL, PLAYERZONE_OTHER},
			effectCode:       SPELL_ADD_RUNES,
			effectValue1:     1,
			effectValue2:     1,
		},
	},
	...
	&unitCard{
		...
		baseAtk:   3,
		baseHP:    4,
		// specials:     []unitPassiveAbility{{name: "Frenzy", value: 1}},
	},
	&unitCard{
		cost:             2,
		...
		baseAtk:          3,
		baseHP:           3,
		passiveAbilities: []unitPassiveAbility{{code: UPA_SPARKSHOT}},
	},
	&unitCard{
		cost:      4,
		name:      "Hired Stomper",
	...
	&unitCard{
		...
		baseAtk:          4,
		baseHP:           3,
		passiveAbilities: []unitPassiveAbility{{code: UPA_FLYING}},
		// Arrives: gets stealth this turn
	},
	&unitCard{
		cost:             5,
		...
		baseAtk:          6,
		baseHP:           5,
		passiveAbilities: []unitPassiveAbility{{code: UPA_OVERPOWER}},
		// Arrives: gets stealth this turn
	},
	&unitCard{
		cost:             7,
		...
		baseAtk:          8,
		baseHP:           9,
		passiveAbilities: []unitPassiveAbility{{code: UPA_OBLITERATE, value: 2}},
	...
	&unitCard{
		...
		baseAtk:          3,
		baseHP:           3,
		passiveAbilities: []unitPassiveAbility{{code: UPA_INVISIBLE}},
	},
	&unitCard{
		cost:             2,
		name:             "Cloud Sprite",
	...
	&unitCard{
		...
		baseAtk:          3,
		baseHP:           5,
		passiveAbilities: []unitPassiveAbility{{code: UPA_ANTI_AIR}},
	},
	&unitCard{
		cost:      6,
		name:      "Blademaster",
